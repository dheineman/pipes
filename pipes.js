...
/**
  * Get pipe at the coordinates
  */
grid.getPipe = function(x, y){
...
/**
  * Check all pipes if active
  */
grid.checkPipes = function() {
	connected_pipes = [];
	pipes_to_check = [];
